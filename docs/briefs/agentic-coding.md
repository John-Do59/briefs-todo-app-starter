# Brief Métier : Agentic coding sur une app To-Do
...
Face aux défis de l'agentic coding...
L’objectif est de migrer...
...
1. **Installer un CLI / IDE agentique**
2. **Mise en place du context statique du projet**
    - AGENTS.md racine
    - AGENTS.md hierarchique
    - docs
3. **Prise en main context dynamique**
    -
4.
